...
class HuggingFaceModel(ComposerModel):
    ...
    def __init__(
        ...
        fail_on_vocab_mismatch: bool = True,
    ) -> None:
        try:
            import transformers
        ...
        self._check_tokenizer_and_maybe_resize_embeddings(allow_embedding_resizing,fail_on_vocab_mismatch)
    ...
    def _check_tokenizer_and_maybe_resize_embeddings(self, allow_embedding_resizing: bool,fail_on_vocab_mismatch:bool) -> None:

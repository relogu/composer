"""
This module contains the NoiseScaleMonitor callback for estimating the noise scale during training.
...
class NoiseScaleMonitor(Callback):
    ...
    def after_backward(self, state: State, logger: Logger) -> None:
        ...
        for i, (name, p) in enumerate(state.model.named_parameters()):
    ...
    def batch_end(self, state: State, logger: Logger) -> None:
        ...
        for i, name in enumerate(self.last_gradients_store.keys()):
        ...
        logger.log_metrics(
            ...
            "noise_scale/g_small_l2norm_squared": self.g_small_l2norm_squared,
